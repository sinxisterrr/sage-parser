...
function injectJobId(req: any, _res: express.Response, next: express.NextFunction) {
...
app.post(
  ...
  async (req: any, res: express.Response) => {
    ...
    const databaseUrl = (req.body?.databaseUrl as string) || process.env.DATABASE_URL;
    const embedderUrl = (req.body?.embedderUrl as string) || process.env.EMBEDDER_URL;
