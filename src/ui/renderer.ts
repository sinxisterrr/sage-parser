...
import { color, CYAN, GREEN, YELLOW, MAGENTA } from "./colors.js";
...
//--------------------------------------------------------------
export async function askDedupeMode(goblin = false): Promise<"accurate" | "fast"> {
...
//--------------------------------------------------------------
export function renderNormalUI(
  activeThreads: Map<number, any>,
  completed: number,
  total: number
) {
...
//--------------------------------------------------------------
export function renderGoblinUI(
  activeThreads: Map<number, any>,
  completed: number,
  total: number
) {
